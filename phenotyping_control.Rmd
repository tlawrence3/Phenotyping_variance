...
mean(lmtidyoutput$estimate)
sd(lmtidyoutput$estimate)
...
the above gives you 95% CI for that distribution, the problem will be translating that to variable starting size of the QTL population.
